        ...
        $('.sb').reverse().each(function() {
           var href = $(this).attr('href');
            if ($(this).attr('title')) {
                ...
                $('.sb-items').append('<div class="sb-item"><div class="sb-caption">'+ caption +'</div><img style="width: 640px;height:423px;" src="'+ href + '"/></div>');
            }
            else {
                  $('.sb-items').append('<div class="sb-item"><img style="width: 640px;height:423px;" src="'+ href + '"/></div>');
